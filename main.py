    ...
    <div id="adminPanel" style="display:none;">
        <div class="section">
            ...
            <form id="updateForm">
                ...
                <textarea id="newNotification" placeholder="Enter notification text..." required></textarea>
        ...
        async function fetchUpdates() {
            ...
            if (Array.isArray(data)) {
                data.forEach((u) => {
                    ...
                    div.textContent = "Update: " + u.message + " | Notification: " + u.notification;
                    container.appendChild(div);

                    let prevDiv = document.createElement("div");
                    prevDiv.className = "update";
                    prevDiv.textContent = "Update: " + u.message + " | Notification: " + u.notification;
